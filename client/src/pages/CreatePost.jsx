...
const CreatePost = () => {
  ...
  return (
    ...
    <div>
      ...
      imaginative and visually stunning images through FALL-E AI and share them with the community</p> 
    </div>
    ...
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
      <div className='flex flex-col gap-5'>
        ...
        <FormField
          ...
          type='text'
          name='prompt'
          placeholder='A plush toy robot sitting gainst a yellow wall'
          value={form.prompt}
          handleChange={handleChange}
          isSurpriseMe
          ...
          <div className='mt-5 flex gap-5'>
              ...
              created the image you want, you can share it with others in the community</p>
                <button
                  type="submit"
